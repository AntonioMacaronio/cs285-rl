...
def run_training_loop(logger, args):
    ...
    for itr in range(args.n_iter):
        ...
        train_info: dict = agent.update(
            trajs_dict["observation"],  # list of (T_i, ob_dim) arrays
            trajs_dict["action"],       # list of (T_i,) or (T_i, ac_dim) arrays
            trajs_dict["reward"],       # list of (T_i,) arrays
            trajs_dict["terminal"]      # list of (T_i,) arrays
        )
